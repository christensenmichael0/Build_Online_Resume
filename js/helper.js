...
var HTMLheaderRole = '<span id="my-role">%data%</span><hr>';
...
var HTMLworkDescription = '<ul class="list-entry"><br></ul>';
var HTMLworkDescriptionBullets = "<li class='work-bullets'>%data%</li>";
...
var HTMLonlineClasses = '<h3 id="online-classes">Online Classes</h3>';
...
requires you to create a function that will need this helper code to run. 
*/
